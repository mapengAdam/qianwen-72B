...
class QWenModel(QWenPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.rotary_emb = RotaryEmbedding(dim, base=config.rotary_emb_base, seq_length_expansion=config.seq_length_expansion if hasattr(self.config, 'seq_length_expansion') else 1)
...
class RotaryEmbedding(torch.nn.Module):
    def __init__(self, dim, base=10000, seq_length_expansion=1):
        super().__init__()
        self.dim = dim
        self.base = base
        ...
        self.seq_length_expansion = seq_length_expansion
    ...
    def update_rotary_pos_emb_cache(self, max_seq_len, offset=0, ntk_alpha=1.0):
        ...
        if seqlen > self._seq_len_cached or ntk_alpha != self._ntk_alpha_cached:
            ...
            seq = seq/self.seq_length_expansion
